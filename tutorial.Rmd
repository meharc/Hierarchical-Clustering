...
* **Centroid Linkage**— It is the farthest distance between two clusters, A and B. To compute this, we calculate the pairwise distance between data points in cluster A and B and use the largest distance.

* **Average Linkage**—  It is the distance between the centroids (mean) of clusters A and B.
